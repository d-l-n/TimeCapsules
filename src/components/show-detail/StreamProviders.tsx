    ...
    <div>
      <div className="flex items-center gap-2 mb-2">
        ...
        <select
          ...
          className="border-2 border-border bg-surface text-xs font-bold px-1.5 py-0.5 uppercase cursor-pointer hover:bg-accent transition-colors"
          ...
          {providers.providers.map(p => {
            ...
            return (
              <a
                ...
                className="border-2 border-border px-2 py-1 text-xs font-bold bg-surface flex items-center gap-1.5 hover:bg-accent transition-colors"
              >
