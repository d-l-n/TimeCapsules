...
export const DarkLightIcon = () => (
  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path d="M12 8v8c2.2 0 4-1.8 4-4s-1.8-4-4-4Z" />
    <path d="M12 16c-2.2 0-4-1.8-4-4s1.8-4 4-4V2.3C6.7 2.3 2.3 6.7 2.3 12s4.4 9.7 9.7 9.7v-5.7Z" />
    <circle cx="12" cy="12" r="9.7" fill="none" stroke="currentColor" strokeWidth="1.5" />
  </svg>
)
...
export const ArrowRightIcon = ({ className = 'w-3 h-3' }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="square" aria-hidden="true">
