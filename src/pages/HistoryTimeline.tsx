  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 border-b-4 border-border pb-4">
        ...
        <select value={selected} onChange={e => setSelected(e.target.value)} className="border-4 border-border bg-surface px-3 py-2 text-sm font-bold uppercase cursor-pointer w-full sm:w-auto" aria-label={t.history.filterByMonth}>
